...
public record EmployeeDtoListResponse(
    ...
    public static org.example.app.dto.employee.EmployeeDtoListResponse of(boolean isEmployeeListEmpty, List<Employee> list) {
        return isEmployeeListEmpty ?
                new org.example.app.dto.employee.EmployeeDtoListResponse(
